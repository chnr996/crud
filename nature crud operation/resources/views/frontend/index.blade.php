                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="avatar-group d-flex flex-wrap align-items-center">
                                <img src="{{asset('assetes/images/avatar/portrait-beautiful-young-woman-standing-grey-wall.jpg')}}" class="img-fluid avatar-image" alt="">

                                <img src="{{asset('assetes/images/avatar/portrait-young-redhead-bearded-male.jpg')}}" class="img-fluid avatar-image avatar-image-left" alt="">

                                <img src="{{asset('assetes/images/avatar/pretty-blonde-woman.jpg')}}" class="img-fluid avatar-image avatar-image-left" alt="">

                                <img src="{{asset('assetes/images/avatar/studio-portrait-emotional-happy-funny-smiling-boyfriend.jpg')}}" class="img-fluid avatar-image avatar-image-left" alt="">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="{{asset('assetes/images/tablet-screen-contents.jpg')}}" class="img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-8 col-12">
                            <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true" class="scrollspy-example-2" tabindex="0">
                                ...
                                <div class="scrollspy-example-item" id="item-2">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-12 mb-3">
                                            <img src="{{asset('assetes/images/portrait-mature-smiling-authoress-sitting-desk.jpg')}}" class="scrollspy-example-item-image img-fluid" alt="">
                                        </div>

                                        <div class="col-lg-6 col-12 mb-3">
                                            <img src="{{asset('assetes/images/businessman-sitting-by-table-cafe.jpg')}}" class="scrollspy-example-item-image img-fluid" alt="">
                                        </div>
                                    </div>
                                ...
                                <div class="scrollspy-example-item" id="item-4">
                                    ...
                                    <img src="{{asset('assetes/images/portrait-mature-smiling-authoress-sitting-desk.jpg')}}" class="scrollspy-example-item-image img-fluid mb-3" alt="">
            ...
            <section class="author-section section-padding" id="section_3">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="{{asset('assetes/images/portrait-mature-smiling-authoress-sitting-desk.jpg')}}" class="author-image img-fluid" alt="">
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="custom-block d-flex flex-wrap">
                                <div class="custom-block-image-wrap d-flex flex-column">
                                    <img src="{{asset('assetes/images/avatar/pretty-blonde-woman.jpg')}}" class="img-fluid avatar-image" alt="">
